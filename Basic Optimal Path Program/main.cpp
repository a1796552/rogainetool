...
int main() {
    ...
    int scale=getScale(image),distance;
    ...
    std::cout << "Greedy: ";
    for (int id : greedy.visitedPath) std::cout << id<<"("<<points[id].getID()<<") ";
    std::cout << " | D=" << pixToKilometres(greedy.totalDistance,scale) << " kilometres P=" << greedy.totalPoints << "\n";
