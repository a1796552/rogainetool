/* This main file takes input directly from files. This is used for algorithm test purposes.
Uses an input file and hard coded max distance to test algorithms */
